...
function A() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Hello, route A" });
}
function B() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Hello, route B" });
}
function Index() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx("h1", { children: "Index" }) });
}
const routes = [
  {
    path: "/guide",
    element: /* @__PURE__ */ jsxRuntime.jsx(Index, {})
  },
  {
    path: "/guide/a",
    element: /* @__PURE__ */ jsxRuntime.jsx(A, {})
  },
  {
    path: "/b",
    element: /* @__PURE__ */ jsxRuntime.jsx(B, {})
  }
];
const Content = () => {
...
function render() {
  return server.renderToString(
    /* @__PURE__ */ jsxRuntime.jsx(StaticRouter, { location: "/guide/a", children: /* @__PURE__ */ jsxRuntime.jsx(App, {}) })
  );
}
